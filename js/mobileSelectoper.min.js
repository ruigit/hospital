...
(function() {
	...
	MobileSelect.prototype = {
		...
		renderWheels: function(wheelsData, cancelBtnText, ensureBtnText) {
			...
			_this.mobileSelect.innerHTML = '<div class="grayLayer"></div>' + '<div class="content">' + '<div class="btnBar">' + '<div class="fixWidth">' + '<div class="title"></div>' + "</div>" + "</div>" + '<div class="panel">' + '<div class="fixWidth">' + '<div class="wheels">' + "</div>" + '<div class="selectLine"></div>' + '<div class="selectLineper"><ul class="column-ul"><p>右乳</p><li></li></ul></div>' + '<div class="shadowMask"></div>' + '<div class="shadowMaskper"></div>' + "</div>" + "</div>" + '<div class=" ensure">' + ensureText + "</div>" + '<div class="cancel">' + cancelText + "</div>" + "</div>";
        ...
        fixRowStyle: function() {
            var _this = this;
            _this.wheel[0].style.width = 80 + "%"
            _this.wheel[1].style.width = 80 + "%"
