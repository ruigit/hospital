...
(function() {
	...
	MobileSelect.prototype = {
		...
		renderWheels: function(wheelsData, cancelBtnText, ensureBtnText) {
			...
			_this.mobileSelect.innerHTML = '<div class="grayLayer"></div>' + '<div class="content">' + '<div class="btnBar">' + '<div class="fixWidth">' + '<div class="title"></div>' + "</div>" + "</div>" + '<div class="panel">' + '<div class="fixWidth">' + '<div class="wheels">' + "</div>" + '<div class="selectLine"></div>' + '<div class="shadowMask"></div>' + "</div>" + "</div>" + '<div class=" ensure">' + ensureText + "</div>" + '<div class="cancel">' + cancelText + "</div>" + "</div>";
